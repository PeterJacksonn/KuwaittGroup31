...
if (isset($_POST['submit'])){
    ...
    $db = new SQLite3('..\\Database\\Kuwaitt.db');
    $sql = "UPDATE documents SET archive = ' ' WHERE docID = :uid";
    $stmt = $db->prepare($sql);
...
<h2 class="text">Archive Document ID: <?php echo $_GET['uid'];?></h2><br>
        <h2 style="color: red;">Are you sure want to Un-Archive Document: <?php echo $arrayResult[0][0] ?>?</h2><br>
        ...
        <div class="row">
            <div class="col-5">
                <form method="post">
                    ...
                    <input type="submit" value="Un-Archive" class="btn-primary" name="submit"><a href="managerIndex.php" style="font-weight: bold; padding-left: 30px;">Back</a>
                </form>
            </div>
        </div>