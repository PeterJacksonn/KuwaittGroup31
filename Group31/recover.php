...
if (isset($_POST['submit'])){
    ...
    $db = new SQLite3('..\\Database\\Kuwaitt.db');
    $sql = "UPDATE documents SET deleted = ' ' WHERE docID = :uid";
    $stmt = $db->prepare($sql);
...
?>
<div class="home">
<h2 class="text">Deleted Document ID: <?php echo $_GET['uid'];?></h2><br>
        <h2 style="color: red;">Are you sure want to Recover Document: <?php echo $arrayResult[0][0] ?>?</h2><br>
        ...
        <div class="row">
            <div class="col-5">
                <form method="post">
                    ...
                    <input type="submit" value="Recover" class="btn-primary" name="submit"><a href="managerIndex.php" style="font-weight: bold; padding-left: 30px;">Back</a>
                </form>
            </div>
        </div>