        ...
        <main role="main" class="pb-3">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="UpdateUser.php?uid=<?php echo $user[$i]['userId']; ?>" class="btn btn-info">Update</a></td>
                        <td><a href="DeleteUser.php?uid=<?php echo $user[$i]['userId']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
                    <?php endfor;?>
                </table>    
            </div>
